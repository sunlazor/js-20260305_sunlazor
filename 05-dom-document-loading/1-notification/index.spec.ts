...
describe('dom-document-loading/notification', () => {
  ...
  it('should have ability to set duration', () => {
    ...
    expect(notificationMessage.element!.style.getPropertyValue('--value')).toBe(expectedDuration);
  });
  ...
  it('should be removed after time defined in duration property', () => {
    ...
    const removeMethod = vi.spyOn(notificationMessage, 'remove');
  ...
  it('should have ability to be destroyed', () => {
    const element = notificationMessage.element;
